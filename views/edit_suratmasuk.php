...
include "../controllers/c_suratmasuk.php";
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-1 font-weight-bold text-primary">Edit Data Surat Masuk</h6>
                    </div>

                    <?php foreach($suratmasuk->edit($_GET["id"]) as $edit) : ?>
                    <form class="user" action="../routers/r_suratmasuk.php?aksi=edit" method="post" enctype="multipart/form-data">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="Asal" name="asal" value="<?= $edit->asal ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="Keterangan" name="keterangan" value="<?= $edit->keterangan ?>">
                            </div>
